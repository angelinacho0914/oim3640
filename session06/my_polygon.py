...
def polyline(t, n, length, angle):
    """Takes in 4 parameters needed for the turtle to draw
    a line with given length and angle"""
    for i in range(n):
        t.fd(length)
        t.lt(angle)
...
def polygon(t, n, length):
    """Takes in 3 parameters needed for the turtle to draw
    a polygon with given length and # of sides"""
    angle = 360.0 / n
...
def circle(t, r):
    """Takes in 2 parameters needed for the turtle to draw
    a line with given radius"""
    arc(t, r, 360)
